...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\asubject\x18\x01 \x01(\tR\asubject2\xd9\x03\n" +
	"\x04Auth\x12<\n" +
	"\aSendOTP\x12\x17.auth.v1.SendOTPRequest\x1a\x18.auth.v1.SendOTPResponse\x12B\n" +
	"\tVerifyOTP\x12\x19.auth.v1.VerifyOTPRequest\x1a\x1a.auth.v1.VerifyOTPResponse\x129\n" +
	...
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponseB?Z=github.com/co1seam/ember-backend-api-contracts/auth/v1;authv1b\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	0,  // 0: auth.v1.Auth.SendOTP:input_type -> auth.v1.SendOTPRequest
	2,  // 1: auth.v1.Auth.VerifyOTP:input_type -> auth.v1.VerifyOTPRequest
	4,  // 2: auth.v1.Auth.SignUp:input_type -> auth.v1.SignUpRequest
	6,  // 3: auth.v1.Auth.SignIn:input_type -> auth.v1.SignInRequest
	8,  // 4: auth.v1.Auth.SignOut:input_type -> auth.v1.SignOutRequest
	10, // 5: auth.v1.Auth.RefreshToken:input_type -> auth.v1.RefreshTokenRequest
	12, // 6: auth.v1.Auth.ValidateToken:input_type -> auth.v1.ValidateTokenRequest
	1,  // 7: auth.v1.Auth.SendOTP:output_type -> auth.v1.SendOTPResponse
	3,  // 8: auth.v1.Auth.VerifyOTP:output_type -> auth.v1.VerifyOTPResponse
	5,  // 9: auth.v1.Auth.SignUp:output_type -> auth.v1.SignUpResponse
	7,  // 10: auth.v1.Auth.SignIn:output_type -> auth.v1.SignInResponse
	9,  // 11: auth.v1.Auth.SignOut:output_type -> auth.v1.SignOutResponse
	11, // 12: auth.v1.Auth.RefreshToken:output_type -> auth.v1.RefreshTokenResponse
	13, // 13: auth.v1.Auth.ValidateToken:output_type -> auth.v1.ValidateTokenResponse
