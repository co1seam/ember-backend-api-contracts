...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\asubject\x18\x01 \x01(\tR\asubject2\xaf\x03\n" +
	"\x04Auth\x126\n" +
	...
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB?Z=github.com/co1seam/ember-backend-api-contracts/auth/v1;authv1b\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	12, // 6: auth.Auth.ValidateToken:input_type -> auth.ValidateTokenRequest
	1,  // 7: auth.Auth.SendOTP:output_type -> auth.SendOTPResponse
	3,  // 8: auth.Auth.VerifyOTP:output_type -> auth.VerifyOTPResponse
	5,  // 9: auth.Auth.SignUp:output_type -> auth.SignUpResponse
	7,  // 10: auth.Auth.SignIn:output_type -> auth.SignInResponse
	9,  // 11: auth.Auth.SignOut:output_type -> auth.SignOutResponse
	11, // 12: auth.Auth.RefreshToken:output_type -> auth.RefreshTokenResponse
	13, // 13: auth.Auth.ValidateToken:output_type -> auth.ValidateTokenResponse
